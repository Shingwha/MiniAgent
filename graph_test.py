...
# 创建 Agent
get_weather_agent = Agent(llm=llm,tools=[duckduckgo_search],content_prompt="你需要调用工具获取长春的天气")
get_news_agent = Agent(llm=llm,tools=[duckduckgo_search, get_time],content_prompt="你需要根据今天的日期时间获取当日AI科技新闻")
