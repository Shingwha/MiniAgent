...
llm = ChatOpenAI()
llm.load_config("glm.json") # 格式为{"api_key":"your_api_key","model_name":"your_model_name","base_url":"your_base_url"}
...
agent.set_content_prompt(f"你是用户的知心朋友，你的语气需要很自然很友善，略带一些俏皮，要记住现在的时间是：{get_time()}，下面是用户的问题，请你合理回答：")
